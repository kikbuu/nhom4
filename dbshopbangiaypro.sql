USE [master]
GO
/****** Object:  Database [ShopBanGiayPro]    Script Date: 19/12/2015 05:13:16 PM ******/
CREATE DATABASE [ShopBanGiayPro]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ShopBanGiayPro', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ShopBanGiayPro.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ShopBanGiayPro_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ShopBanGiayPro_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
USE [ShopBanGiayPro]
GO
/****** Object:  Table [dbo].[ct_hoadon]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ct_phieunhap]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ct_sanpham]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[hoadon]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[loai]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[nhasx]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[phieunhap]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[sanpham]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tonkho]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[user]    Script Date: 19/12/2015 05:13:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[ct_hoadon] ([id], [mahd], [masp], [soluong], [thanhtien]) VALUES (2071, N'ML000004', N'SP000006', 1, 900000)
INSERT [dbo].[ct_hoadon] ([id], [mahd], [masp], [soluong], [thanhtien]) VALUES (2072, N'ML000005', N'SP000006', 20, 18000000)
INSERT [dbo].[ct_hoadon] ([id], [mahd], [masp], [soluong], [thanhtien]) VALUES (2073, N'ML000006', N'SP000009', 1000000, 7999999967232)
INSERT [dbo].[ct_hoadon] ([id], [mahd], [masp], [soluong], [thanhtien]) VALUES (2074, N'ML000007', N'SP000007', 1, 1500000)
INSERT [dbo].[ct_hoadon] ([id], [mahd], [masp], [soluong], [thanhtien]) VALUES (2075, N'ML000008', N'SP000005', 1, 2000000)
...
INSERT [dbo].[ct_phieunhap] ([id], [mapn], [masp], [soluong], [gia], [thanhtien]) VALUES (2012, N'PN000003', N'SP000006', 5, 1000000, 5000000)
INSERT [dbo].[ct_phieunhap] ([id], [mapn], [masp], [soluong], [gia], [thanhtien]) VALUES (2013, N'PN000004', N'SP000009', 5, 1000000, 5000000)
INSERT [dbo].[ct_phieunhap] ([id], [mapn], [masp], [soluong], [gia], [thanhtien]) VALUES (2014, N'PN000004', N'SP000002', 2, 500000, 1000000)
...
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (54, N'HD000001', N'user', CAST(0xAA3A0B00 AS Date), 1, 1)
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (55, N'ML000002', N'user', CAST(0xAA3A0B00 AS Date), 0, 1)
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (1054, N'ML000003', N'vi', CAST(0xC23A0B00 AS Date), 0, 1)
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (1055, N'ML000004', N'vi', CAST(0xCC3A0B00 AS Date), 0, 0)
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (1056, N'ML000005', N'vi', CAST(0xCC3A0B00 AS Date), 1, 1)
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (1057, N'ML000006', N'khai', CAST(0xCC3A0B00 AS Date), 1, 1)
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (1058, N'ML000007', N'khai', CAST(0xCC3A0B00 AS Date), 0, 0)
INSERT [dbo].[hoadon] ([id], [mahd], [username], [ngaymua], [hoanthanh], [Active]) VALUES (1059, N'ML000008', N'khai', CAST(0xCC3A0B00 AS Date), 0, 0)
...
INSERT [dbo].[phieunhap] ([id], [mapn], [ngaynhap], [trangthai], [Active]) VALUES (1, N'PN000001', CAST(0x8B3A0B00 AS Date), 1, 1)
INSERT [dbo].[phieunhap] ([id], [mapn], [ngaynhap], [trangthai], [Active]) VALUES (2, N'PN000002', CAST(0xAA3A0B00 AS Date), 0, 1)
INSERT [dbo].[phieunhap] ([id], [mapn], [ngaynhap], [trangthai], [Active]) VALUES (1002, N'PN000003', CAST(0xCC3A0B00 AS Date), 1, 1)
INSERT [dbo].[phieunhap] ([id], [mapn], [ngaynhap], [trangthai], [Active]) VALUES (1003, N'PN000004', CAST(0xAA3A0B00 AS Date), 1, 1)
SET IDENTITY_INSERT [dbo].[phieunhap] OFF
SET IDENTITY_INSERT [dbo].[sanpham] ON 

INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1037, N'SP000001', N'ML000002', N'SX000002', N'Adidas XK2014', 100, 2200000, CAST(0x613A0B00 AS Date), N'\Images\SanPham\The thao 19.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1038, N'SP000002', N'ML000001', N'SX000003', N'Nike VN', 4, 1600000, CAST(0x7F3A0B00 AS Date), N'\Images\SanPham\The thao 3.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1039, N'SP000003', N'ML000002', N'SX000004', N'Adidas QN Pro', 100, 2200000, CAST(0x613A0B00 AS Date), N'\Images\SanPham\The thao 4.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1040, N'SP000004', N'ML000002', N'SX000006', N'Adidas Pro2015', 100, 3000000, CAST(0x9E3A0B00 AS Date), N'\Images\SanPham\The thao 11.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1041, N'SP000005', N'ML000001', N'SX000006', N'Nike Pro2015', 100, 2000000, CAST(0xA93A0B00 AS Date), N'\Images\SanPham\The thao 17.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1042, N'SP000006', N'ML000004', N'SX000003', N'Kappa Pro 2014', 10, 900000, CAST(0xAA3A0B00 AS Date), N'\Images\SanPham\The thao 8.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1043, N'SP000007', N'ML000003', N'SX000006', N'Rebook Pro 2014', 100, 1500000, CAST(0xAA3A0B00 AS Date), N'\Images\SanPham\The thao 5.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1044, N'SP000008', N'ML000005', N'SX000005', N'Convert Pro 2014', 97, 9000000, CAST(0xAA3A0B00 AS Date), N'\Images\SanPham\The thao 20.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1045, N'SP000009', N'ML000004', N'SX000002', N'Kappa Pro 2013', -999990, 8000000, CAST(0xAA3A0B00 AS Date), N'\Images\SanPham\The thao 7.jpg', 1)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1046, N'SP000010', N'ML000001', N'SX000002', N'Adidas XK2014', 0, 2200000, CAST(0xA93A0B00 AS Date), N'\Images\SanPham\The thao 19.jpg', 0)
INSERT [dbo].[sanpham] ([id], [masp], [maloai], [mansx], [tensp], [soluong], [gia], [ngaynhap], [hinh], [Active]) VALUES (1047, N'SP000011', N'ML000001', N'SX000002', N'Adidas XK2014', 0, 2200000, CAST(0xA93A0B00 AS Date), N'\Images\SanPham\The thao 19.jpg', 0)
SET IDENTITY_INSERT [dbo].[sanpham] OFF
SET IDENTITY_INSERT [dbo].[tonkho] ON 

INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1016, N'SP000001', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1017, N'SP000002', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1018, N'SP000003', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1019, N'SP000004', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1020, N'SP000005', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1021, N'SP000006', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1022, N'SP000007', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1024, N'SP000008', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1025, N'SP000009', CAST(0x7F3A0B00 AS Date), 100)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1034, N'SP000001', CAST(0x8B3A0B00 AS Date), 109)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1035, N'SP000003', CAST(0x8B3A0B00 AS Date), 108)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1038, N'SP000009', CAST(0xAA3A0B00 AS Date), 98)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (1039, N'SP000008', CAST(0xAA3A0B00 AS Date), 97)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2016, N'SP000006', CAST(0xCC3A0B00 AS Date), 80)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2017, N'SP000006', CAST(0xCC3A0B00 AS Date), 5)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2018, N'SP000006', CAST(0xCC3A0B00 AS Date), 10)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2019, N'SP000009', CAST(0xCC3A0B00 AS Date), 5)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2020, N'SP000002', CAST(0xCC3A0B00 AS Date), 2)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2021, N'SP000009', CAST(0xCC3A0B00 AS Date), 10)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2022, N'SP000002', CAST(0xCC3A0B00 AS Date), 4)
INSERT [dbo].[tonkho] ([id], [masp], [ngaycapnhat], [soluongton]) VALUES (2023, N'SP000009', CAST(0xCC3A0B00 AS Date), -999990)
SET IDENTITY_INSERT [dbo].[tonkho] OFF
SET IDENTITY_INSERT [dbo].[user] ON 

INSERT [dbo].[user] ([id], [username], [password], [hoten], [gioitinhnam], [ngaysinh], [diachi], [sdt], [hinh], [email], [quyenhang], [Active]) VALUES (1, N'admin', N'123456', N'Phan Thiên Phúc', 1, CAST(0x801A0B00 AS Date), N'3 An Dương Vương, P12, Q5', N'0976656454 ', N'/ckfinder/userfiles/images/User/WMP118af8ed-835a-449b-a247-9e01bce04f07.jpg', N'dangcapgiayhieu@gmail.com', N'admin', 1)
INSERT [dbo].[user] ([id], [username], [password], [hoten], [gioitinhnam], [ngaysinh], [diachi], [sdt], [hinh], [email], [quyenhang], [Active]) VALUES (10, N'hai', N'123456', N'Nguyễn Hải', 1, CAST(0xB41D0B00 AS Date), N'', N'           ', N'/ckfinder/userfiles/images/User/WMP2fd574da-79db-4c92-8915-c5372d0e468d.jpg', N'', N'admin', 1)
